...
`,P=f.default.Text`
  font-size: 18px;
  color: #fff;
`,_=i.default.create({container:{flex:1},image:{flex:1,justifyContent:"center"},text:{color:"white",fontSize:42,lineHeight:84,fontWeight:"bold",textAlign:"center",backgroundColor:"#000000c0"}});n(5415);const z=function(){var e=(0,r.useState)(""),t=(0,c.default)(e,2),n=t[0],o=t[1],i=(0,r.useState)(""),l=(0,c.default)(i,2),a=l[0],f=l[1],p=(0,r.useState)(!1),g=(0,c.default)(p,2),z=g[0],V=g[1],R=(0,r.useState)(1),A=(0,c.default)(R,2),E=A[0],H=A[1],I=(0,r.useState)(""),M=(0,c.default)(I,2),B=M[0],D=M[1],N=(0,r.useState)(!1),W=(0,c.default)(N,2),L=W[0],q=W[1],$=function(e){H("increment"===e?E+1:E>1?E-1:1)};return(0,h.jsxs)(d.default,{style:_.container,children:[!L&&(0,h.jsxs)(j,{children:[(0,h.jsx)(m,{children:"Cryptlink"}),(0,h.jsx)(w,{children:(0,h.jsx)(k,{placeholder:"www.google.com",placeholderTextColor:"#c0c0c0",value:n,onChangeText:function(e){o(e)}})}),(0,h.jsx)(w,{children:(0,h.jsx)(k,{placeholder:"abel123",placeholderTextColor:"#c0c0c0",secureTextEntry:!0,value:a,onChangeText:function(e){f(e)}})}),(0,h.jsxs)(w,{children:[(0,h.jsx)(u.default,{onPress:function(){V(!z)},children:(0,h.jsx)(O,{isChecked:z,children:z&&(0,h.jsx)(S,{isChecked:z,children:"\u2713"})})}),(0,h.jsx)(v,{children:" Auto Deletar"}),z&&(0,h.jsxs)(w,{style:{paddingTop:20},children:[(0,h.jsx)(d.default,{style:{marginBottom:20}}),(0,h.jsx)(T,{onPress:function(){return $("decrement")},children:(0,h.jsx)(P,{children:"-"})}),(0,h.jsx)(C,{placeholder:"N\xfamero de visualiza\xe7\xf5es",editable:!1,value:E.toString()}),(0,h.jsx)(T,{onPress:function(){return $("increment")},children:(0,h.jsx)(P,{children:"+"})})]})]}),(0,h.jsx)(y,{children:(0,h.jsx)(s.default,{title:"Encriptar",disabled:!n||!a,onPress:function(){x.default.post("https://cryptlink-api.abelcode.dev/encrypt",{url:n,senha:a,auto_delete:z,numero_exibicao:E}).then((function(e){o(""),f(""),V(!1),H(0),D("https://cryptlink.abelcode.dev/"+e.data.id),q(!0)})).catch((function(e){console.log(e),alert(e.message)}))}})})]}),L&&(0,h.jsx)(b,{link:B,func:function(){D(""),q(!1)}})]})};var V=f.default.View`
  flex: 1;
  justify-content: center;
  align-items: center;
  background-color: #090909b3;
...
//# sourceMappingURL=main.8c1b1614.js.map